...
cspice_furnsh('/Users/minduli/Astroscale_ADR/Main/SGP4routines_NAIF/kernelmac.txt')
...
SPK1 = strcat('kernels/SPK',Norad1,'.bsp');
MAXIV  = 1000;
WINSIZ = 2 * MAXIV;
...
for i = 1: length(timevec)
    ...
    [rr, vv, E, mass] = getPosition(timevec(i), 'H2AF15', param.mu);
